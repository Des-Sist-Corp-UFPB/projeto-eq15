...
function DashboardCard({ icon: Icon, title, description, onClick, disabled = false }: DashboardCardProps) {
  return (
    <button
      onClick={onClick}
      disabled={disabled}
      className="group w-full text-left bg-white rounded-xl border border-gray-200 p-6
    ...
    >
      <div className="flex items-start justify-between gap-4">
        <div className="flex items-start gap-4">
          {/* Ícone */}
          <div className="shrink-0 bg-indigo-50 group-hover:bg-indigo-100 rounded-xl p-3 transition-colors">
        ...
        <ChevronRight
          size={18}
          className="shrink-0 mt-0.5 text-gray-300 group-hover:text-indigo-400 transition-colors"
        />
      </div>
    </button>
  )
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="flex-1 px-6 py-10">
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          {/* Badge de perfil */}
          <div className="inline-flex items-center gap-2 bg-indigo-50 border border-indigo-200 rounded-full px-3 py-1">
