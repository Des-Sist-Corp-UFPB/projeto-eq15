...
import { BookOpen, FolderPlus, Users, ArrowLeft, Archive } from 'lucide-react'
      ...
      <header className="bg-indigo-700 text-white px-6 py-4">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="font-semibold text-sm">Minhas Organizações</span>
          </div>
          <div />
        </div>
      </header>
      ...
      <main className="flex-1 px-6 py-8">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="flex items-center justify-between">
            <h1 className="text-xl font-bold text-gray-900 dark:text-gray-100">Organizações</h1>
            {canCreate && (
              <button
