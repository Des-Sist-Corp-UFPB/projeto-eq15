...
- O fornecimento da matrícula do usuário institucionalizado é obrigatória
...
- O sistema deve registrar esse fluxo via loggersDb
...
**Descrição:**
Funcionalidade que permite ao usuário autenticado consultar e atualizar (consulta em uma rota e atualizacao em outra rota PUT) suas próprias informações cadastrais.
